...
import { Bell, CheckCheck, Package, DollarSign, Tag, AlertCircle } from "lucide-react";
...
function notifIcon(type: string) {
  ...
  if (type.includes("PAYOUT") || type.includes("SOLD")) return <DollarSign className="h-4 w-4 text-emerald-500" />;
  if (type.includes("LIVE")) return <Tag className="h-4 w-4 text-purple-500" />;
  if (type.includes("NEGOTIATION")) return <DollarSign className="h-4 w-4 text-amber-500" />;
